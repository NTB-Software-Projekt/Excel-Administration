...
\begin{tabular}{r|p{12cm}}
	1. Filechooser Test & Im Menu Strip: File -> Choose Excel File \\
						...
						& Status:  Pass\hspace{9.5cm} \color{green} {\ding{51}} \\
						\\
	...
	2. Excel File Auswahl & Im File Chooser die gewünschte Datei auswählen und auf OK drücken. \\
						...
						& Status:  Pass\hspace{9.5cm} \color{green} {\ding{51}} \\
						\\
	3. Mitglied Anklicken & In der Tabelle das entsprechende Mitglied anklicken. \\
							& Das PersonWindow wird geöffnet mit allen Informationen über das Mitglied.\\
							& Status:  Pass\hspace{9.5cm} \color{green} {\ding{51}} \\
							\\
\end{tabular}
% Bis hier.
% Ab hier kopieren.
\textbf{Datenbank Tests\\}
\rule[2mm]{1\linewidth}{0.3mm}
\begin{tabular}{r|p{12cm}}
	1. Filechooser Test & Im Menu Strip -> File -> Choose Excel File \\
