...
Vielleicht noch was über das Stunden Journal ? 
...
\begin{tabular}{l|p{12cm}}
	...
	%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
		...
		Erwartetes Ergebnis: 	& Neue Daten sind in der Datenbank vorhanden. \\
								...
								\\	
	%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
	\textbf{2.5 Löschen von Daten:} & Ganze Zeilen (Mitglieder) in der Datenbank löschen.\\
...
* Da unser OleDB Connector mit dem ISAM Treiber das direkte löschen von Zeilen (SQL-DELETE) in einer gelinkten Liste nicht unterstützt, mussten wir dies wie früher erklärt umgehen. Jedoch funktioniert unsere Lösung nicht ganz wie erwartet. Der Bug wird offensichtlich \textbf{nur} wenn wir den letzten Eintrag in der Tabelle "löschen". Nach der "DELETE Erfolgsmeldung" funktionieren keine neuen Interaktionen mit der Datenbank. In diesem Fall liefert die Applikation auch im Debug Modus keine Fehlermeldungen, weshalb wir vermuten das dies ein Excel-Ordnungsproblem ist. \\
